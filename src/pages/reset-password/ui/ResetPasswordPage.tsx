...
export function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(getApiErrorMessage(err, 'Ссылка недействительна или устарела'));
    } finally {
      setSubmitting(false);
    }
  };
        ...
        {!linkValid ? (
          <div className="text-center">
            ...
            <p className="text-[14px] text-slate-500 leading-relaxed">
              В ссылке нет токена или email. Запросите сброс пароля заново.
            </p>
            <Link
              to="/forgot-password"
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-[14px] text-slate-500 mt-2">{email}</p>
            </div>
            ...
            <form onSubmit={e => { void handleSubmit(e); }} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="password" className="text-[13px] font-semibold text-slate-700">Новый пароль</label>
                <input
                  id="password"
                  type="password"
                  value={password}
