...
6. ✅ **[ИСПРАВЛЕНО] Сертификат — PDF с сервера.** Бэкенд (PLAN P3) теперь генерит PDF при
   завершении курса и отдаёт presigned `fileUrl` в сертификате. Клиент: `fileUrl` добавлен в
   `CertificateDtoSchema`/`Certificate`, в `CertificateModal` — кнопка «Скачать PDF» (видна при
   наличии `fileUrl`). Самонарисованная «бумага» осталась как запасной вид/печать.
