...
- Все ваши результаты сохраняются автоматически`,
...

  {
    ...
    modules: [
      {
        id: 'm3-1', title: 'Начало работы',
        steps: [
          {
            id: 's3-1', title: 'Регистрация и вход',
            items: [
              {
                id: 'c3-l1', type: 'lesson', title: 'Как войти в систему',
                content: `# Вход в корпоративный портал\n\nПерейдите на сайт portal.globallearn.ru и введите логин и пароль из письма приглашения.\n\nЕсли вы забыли пароль — нажмите «Восстановить пароль» и следуйте инструкциям.`,
              },
            ],
          },
        ],
      ...
      {
        id: 'm3-2', title: 'Работа с отчётами',
        steps: [
          {
            id: 's3-2', title: 'Экспорт данных',
            items: [
              {
                id: 'c3-l2', type: 'lesson', title: 'Выгрузка отчётов',
                content: `# Экспорт отчётов\n\nВ разделе «Отчёты» выберите нужный период и нажмите «Экспорт в Excel».`,
              },
            ],
          },
        ],
